...
if (tableCount !== 76) failures.push(`expected 76 audited target tables, found ${tableCount}`);
...
if (failures.length > 0) {
  ...
  console.log(
    'V6 contracts verified: 73 source tables, 76 audited target tables, 307 nodes, 197 leaves, 46 domain events, RLS and audit guards.',
  );
}
