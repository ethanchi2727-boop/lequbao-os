...
function completeEnvironment() {
  ...
  for (const name of Object.values(controlledStageRequirements).flat()) {
    if (name === "RELEASE_COMMIT") environment[name] = "a".repeat(40);
    else if (name === "CONTROLLED_RESULTS_FILE")
      environment[name] = path.resolve("results.json");
    else if (name === "PERFORMANCE_ENVIRONMENT")
      environment[name] = "controlled-preproduction";
      ...
      environment[name] = "https://gateway.example.com";
