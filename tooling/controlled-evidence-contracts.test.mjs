  ...
  it('recalculates performance counts, rates and percentile ordering', () => {
    ...
    expect(failures).toEqual(
      expect.arrayContaining([
        ...
        'performance-report.json persistence expectedMessageCount must be a non-negative integer',
        'performance-report.json persistence persistedMessageCount must be a non-negative integer',
  ...
  it('recomputes session lifetime and revocation rejection latency', () => {
    ...
    expect(failures).toEqual(
      expect.arrayContaining([
        ...
        'identity-session-redacted.json revocation.rejectedAt predates the controlled evidence workspace',
        'identity-session-redacted.json mfa.downgradeRejectedAt predates the controlled evidence workspace',
