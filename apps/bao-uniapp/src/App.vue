...
.m-progress-hero::after {
  ...
  height: 280rpx;
  border-radius: 50%;
  background: radial-gradient(closest-side, rgba(110, 199, 38, 0.35), rgba(110, 199, 38, 0));
  content: '';
}
...
.progress-ring {
  ...
  background: conic-gradient(
    var(--bao-mobile-jade-400) var(--progress),
...
.income-hero::before {
  ...
  height: 300rpx;
  border-radius: 50%;
  background: radial-gradient(closest-side, rgba(110, 199, 38, 0.3), rgba(110, 199, 38, 0));
  content: '';
}
.income-hero::after {
  position: absolute;
...
.income-trend path {
  fill: none;
  stroke: var(--bao-mobile-jade-400);
  stroke-width: 3;
}
.income-bars {
  position: absolute;
...
.income-bars text:nth-child(2) {
  height: 42%;
}
.income-bars text:nth-child(3) {
  height: 34%;
}
.income-bars text:nth-child(4) {
  height: 68%;
}
...
.uni-tabbar-bottom
  .uni-tabbar__item:has(.uni-tabbar__label[style*='rgb(11, 149, 105)'])
  .uni-tabbar__bd {
  background: var(--bao-mobile-jade-50);
}
/* #endif */
...
.m-composer text:last-child {
  ...
  height: 63rpx;
  box-shadow:
    0 7rpx 17rpx -3rpx rgba(0, 107, 54, 0.45),
...
.uni-tabbar-bottom .uni-tabbar__label[style*='rgb(0, 107, 54)'] {
...
.avatar-x {
  ...
  background: var(--bao-mobile-gradient-brand);
  box-shadow:
    0 14rpx 31rpx -14rpx rgba(0, 107, 54, 0.55),
